...
uint256 hashGenesisBlock("0xfb1fbbb233ba2933743a71aa309b76213e5229bd82403dfe216be5d895a56df7");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Calafatecoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Calafatecoin Signed Message:\n";
...
{
    // Calafatecoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Calafatecoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 60; // Calafatecoin: 3.5 days
static const int64 nTargetSpacing = 60; // Calafatecoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Calafatecoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Calafatecoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Calafatecoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x890c0dac29466d402a7847bc39540093f03d023f9ef9c1b43e8b49ffea0f970c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("2fd832fe9ab5546e25d96c6ed57a7cb1af4a153393a8c772c0e0fc69d41126e55a1f7ac3c3c6557c6cea0f567bb29227197f6ef884503a2b164f644e5dd35eecb8") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1517243161;
        block.nBits    = 504365644;
        block.nNonce   = 1252902399;

        if (fTestNet)
        {
            block.nTime    = 1517243161;
            block.nNonce   = 1399272179;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x533a0966e73e04de051d8613db10670f54bf52afd88ac368b281b0529a708f24"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Calafatecoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CalafatecoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CalafatecoinMiner : ProcessBlock, block not accepted");
    }
